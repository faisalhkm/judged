...
const FAQS = [
  ...
  },
  {
    ...
    a: "Judged butuh akses ke top tracks dan top artists lo buat bisa nge-judge selera musik lo secara personal. Tanpa data ini, roasting-nya bakal generik.",
  },
  {
  ...
  },
  {
    ...
    a: 'Bisa. Klik tombol "Download PNG" di bawah hasil judging lo.',
  },
  {
      ...
      <div className="max-w-xl mx-auto">
        ...
        <div className="mb-14">
          ...
          <p className="text-zinc-400 text-sm leading-relaxed mb-4">
            ...
            favorit lo, dan "The Music Pathologist" bakal ngejudge kepribadian
