...
export default function ContactPage() {
  return (
    <main className="min-h-screen bg-zinc-950 flex flex-col px-6 py-16">
      <div className="max-w-xl mx-auto w-full flex-1">
        ...
        <p className="text-zinc-500 text-sm mb-10">
          Ada pertanyaan, saran, atau mau ngomongin soal selera musik yang buruk?
        </p>
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            ...
            <div>
              ...
              <p className="text-zinc-500 text-xs mt-0.5">{CONTACT_EMAIL}</p>
            </div>
            <svg className="w-4 h-4 text-zinc-700 ml-auto group-hover:text-zinc-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <div>
              ...
              <p className="text-zinc-500 text-xs mt-0.5">@{INSTAGRAM_HANDLE}</p>
            </div>
            <svg className="w-4 h-4 text-zinc-700 ml-auto group-hover:text-zinc-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
